...
public:
    int difficultyPicker() // Picks a difficulty
    {
        ...
        cout << endl << "Here is your guide for the word verifcation: "<<endl;
    ...
    string askUser(string wordtoGuess)
    {
        string *dictionary = dictionaryAssign();
        int attemptsLeft = 6;
...
int main()
{
    ...
    int chosenDiff;
    string wordtoGuess;
    chosenDiff = wordle.difficultyPicker();
    wordtoGuess = wordle.wordList(chosenDiff);
    int attemptsLeft = 6;

    wordle.askUser(wordtoGuess);
